...
const AnimeCard = ({anime}) => {
  return (
    ...
    <CardHeader>
        ...
        <div>
        <CardTitle className="text-blue-600">{anime.title.substring(0, 15)}</CardTitle>
    ...
    <CardFooter className="flex justify-between">
        ...
        <span className={anime.completed ? `text-md text-green-600 font-bold`:`text-yellow-500 text-md font-bold`}>
